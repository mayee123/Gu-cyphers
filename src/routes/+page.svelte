<script>
    ...
    function submitCommand(e){
        ...
        if(problemIndex < problemStatements.length){
            ...
            addCommand("text-success", "You have solved all the problems! Put both hands up to show you are done!");
            showConfetti = true;
            }
    }
    ...
    onMount(()=>{
        ...
        problemStatements.push("You have one final password to solve: vflhqfh (C?)")
